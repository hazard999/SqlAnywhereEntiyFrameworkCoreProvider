namespace iAnywhere.Data.SQLAnywhere
{
    class SARes
    {
        ...
        public static string GetString(int stringID)
        {
            ...
            string1 = PInvokeMethods.Asa_GetString(stringID, chArray1, bufferLength, ref indicator);
            ...
            else
            {
                ...
                string2 = PInvokeMethods.Asa_GetString(stringID, chArray2, indicator, ref indicator);
