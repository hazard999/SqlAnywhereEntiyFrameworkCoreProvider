...
namespace iAnywhere.Data.SQLAnywhere
{
    ...
    public abstract class SAConnectionStringBuilderBase : DbConnectionStringBuilder
    {
        ...
        internal ConnectionOptions FindConnectionOptions(string key)
        {
            ...
            {
                if (str.Equals(RemoveSpaces(connectionOptions.LongName), StringComparison.OrdinalIgnoreCase) || str.Equals(RemoveSpaces(connectionOptions.ShortName), StringComparison.OrdinalIgnoreCase) || str.Equals(RemoveSpaces(connectionOptions.AlternateName), StringComparison.OrdinalIgnoreCase))
        ...
        public override bool ShouldSerialize(string keyword)
        {
            ...
            if (connectionOptions != null)
            {
                ...
                if (obj != null && !obj.ToString().Equals(connectionOptions.DefaultValue.ToString(), StringComparison.OrdinalIgnoreCase))
                    return true;
            }
            return false;
        }
